...
{
	offset = 0x08000000;
	for(u32 asdha = 0; asdha < 0x00000028; asdha++)
	{
		Process::Read32(offset + 0x90*asdha + 0x03ACB90 , data32);
		data32 += 0x00000111;
		Process::Write32(offset + 0x90*asdha + 0x03ACB90 , data32);
...
{
	Process::Write16(0x0831B45A , 0x7FFE);
}
//火属性
void FireAttribute(MenuEntry *entry)
{
	Process::Write16(0x0831B456 , 0x0001);
}
//水属性
void WaterAttribute(MenuEntry *entry)
{
	Process::Write16(0x0831B456 , 0x0002);
}
//雷属性
void LightningAttribute(MenuEntry *entry)
{
	Process::Write16(0x0831B456 , 0x0003);
}
//龍属性
void DragonAttribute(MenuEntry *entry)
{
	Process::Write16(0x0831B456 , 0x0004);
}
//氷属性
void IceAttribute(MenuEntry *entry)
{
	Process::Write16(0x0831B456 , 0x0005);
}
//毒属性
void PoisonAttribute(MenuEntry *entry)
{
	Process::Write16(0x0831B456 , 0x0006);
}
//麻痺属性
void ParalysisAttribute(MenuEntry *entry)
{
	Process::Write16(0x0831B456 , 0x0007);
}
//睡眠属性
void SleepAttribute(MenuEntry *entry)
{
	Process::Write16(0x0831B456 , 0x0008);
}
//爆破属性
void BombingAttribute(MenuEntry *entry)
{
	Process::Write16(0x0831B456 , 0x0009);
}
//バグ属性
void BugAttribute(MenuEntry *entry)
{
	Process::Write16(0x0831B456 , 0x000A);
}
//バグ属性2
void BugAttribute2(MenuEntry *entry)
{
	...
	Process::Write32(offset + 0x00000000 , 0x00000000);
	offset = 0x08000000;
	if(Process::Read32(offset + 0x0031B456 , cmp32) && cmp32 < 0x00000074)
	{
		Process::Write32(offset + 0x0031B456 , 0x0000000A);
	}
}
//メッセージ連投
...
{
  Process::Write32(0x008F1C0C , 0x00007FFE);
	Process::Write16(0x0831B450 , 0x7FFE);
}
//ボウガン連射
